...
#define SPEED_REVERSE 400
#define SPEED_BRAKE 1480
...
void loop() {
	...
	Serial.println("4");
	delay(5000);
	speedServo.writeMicroseconds(SPEED_FORWARD); //lowspeed ahead
	Serial.println(1000-SPEED_REVERSE);
	delay(5000);
	speedServo.writeMicroseconds(SPEED_BRAKE); //lowspeed ahead
	delay(5000);
	delay(5000);
	speedServo.writeMicroseconds(SPEED_BRAKE); //lowspeed ahead
	delay(5000);
